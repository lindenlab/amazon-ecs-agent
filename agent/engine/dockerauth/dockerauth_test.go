...
func TestDockerCfgAuth(t *testing.T) {
	var expectedPairs = []authTestPair{
		...
		authTestPair{"docker.io/nginx", "dockerhub", "password"},
		authTestPair{"docker.io/busybox", "dockerhub", "password"},
		authTestPair{"docker.io/library/busybox", "dockerhub", "password"},
		authTestPair{"docker.io/amazon/amazon-ecs-agent", "dockerhub", "password"},
