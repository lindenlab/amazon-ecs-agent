...
func createTestEmptyHostVolumeMountTask() *api.Task {
	...
	testTask.Containers[0].Image = testVolumeImage
	testTask.Containers[0].MountPoints = []api.MountPoint{api.MountPoint{ContainerPath: "C:/empty", SourceVolume: "test-tmp"}}
	...
	testTask.Containers[1].MountPoints = []api.MountPoint{api.MountPoint{ContainerPath: "C:/alsoempty/", SourceVolume: "test-tmp"}}
